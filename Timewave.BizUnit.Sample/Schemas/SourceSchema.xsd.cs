namespace Timewave.BizTalkUnit.Sample.Schemas {
    ...
    [Schema(@"http://Timewave.BizTalkUnit.Sample.SourceSchema",@"CustomerOrder")]
    [System.SerializableAttribute()]
    [SchemaRoots(new string[] {@"CustomerOrder"})]
    public sealed class SourceSchema : Microsoft.BizTalk.TestTools.Schema.TestableSchemaBase {
